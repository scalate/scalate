...
class InvalidSyntaxException(
  ...
  // TODO var source: TemplateSource = _

  // TODO def template: String = if (source != null) source.uri else null
...
class StaleCacheEntryException(
  source: Any /*TODO TemplateSource*/ ) extends TemplateException("The compiled template for " + source + " needs to get recompiled") with NoStackTrace
