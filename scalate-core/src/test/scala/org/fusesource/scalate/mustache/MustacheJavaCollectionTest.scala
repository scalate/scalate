 ...
 */
class MustacheJavaCollectionTest extends TemplateTestSupport {

  showOutput = true

  test("iterate ArrayList test") {
    val names = new ju.ArrayList[String]()
    names.add("Hiram")
    names.add("James")
  ...
  test("java.util.Map test") {
    val names = new ju.HashMap[String, String]()
