...
class StripNewlinesTest extends TemplateTestSupport {
  ...
  test("basic newline removal") {
    assertSspOutput("this should be merged into one line", "this should be merged \\\ninto one line")
    assertSspOutput("this should be merged into one line", "this should be merged \\\r\ninto one line")
  }

  test("removal should work at the start of a line") {
    assertSspOutput("this is one line", "\\\nthis is one line")
    assertSspOutput("this is one line", "\\\r\nthis is one line")
  }

  test("removal should work at the end of a line") {
    assertSspOutput("this is one line", "this is one line\\\n")
    assertSspOutput("this is one line", "this is one line\\\r\n")
  }
  ...
  test("double backslash is not an escape character") {
    assertSspOutput("this should stay as \\\ntwo lines", "this should stay as \\\\\ntwo lines")
    assertSspOutput("this should stay as \\\r\ntwo lines", "this should stay as \\\\\r\ntwo lines")
  }
