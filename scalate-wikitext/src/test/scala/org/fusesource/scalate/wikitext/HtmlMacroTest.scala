...
class HtmlMacroTest extends AbstractConfluenceTest {
  test("html macro test") {
    assertFilter("""{html}<p>hello <b>world!</b></p>{html}""", """<p>hello <b>world!</b></p>""")
  }

  test("div macro test") {
    assertFilter("""{div}hello world{div}""", """<div><p>hello world</p></div>""")
  }
...
""",
  ...
  test("multiple links") {
    assertFilter("""[Foo|foo]/[Bar|bar]""", """<p><a href="foo">Foo</a>/<a href="bar">Bar</a></p>""")
  }
