...
task :default => :webgen
task :upload => ["sitecopy:fetch", "sitecopy:upload"]
task :reupload => ["sitecopy:clobber", "sitecopy:fetch", "sitecopy:upload"]
task :deploy => ["sitecopy:clobber", :webgen, "sitecopy:fetch", "sitecopy:upload"]
