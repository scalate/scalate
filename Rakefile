...
task :default => :webgen
task :upload => ["sitecopy:download", "sitecopy:upload"]
task :reupload => ["sitecopy:clobber", "sitecopy:download", "sitecopy:upload"]
task :deploy => ["sitecopy:clobber", :webgen, "sitecopy:download", "sitecopy:upload"]
