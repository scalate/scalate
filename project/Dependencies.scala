...
object Dependencies {
  ...
  val jettyServer = "org.eclipse.jetty" % "jetty-server" % "11.0.7"
  val jettyWebapp = jettyServer.withName("jetty-webapp")
  val jettyUtil = jettyServer.withName("jetty-util")

  val jRubyComplete = "org.jruby" % "jruby-complete" % "9.3.2.0"
  val junit = "junit" % "junit" % "4.13.2"
  val karafShell = "org.apache.karaf.shell" % "org.apache.karaf.shell.console" % "4.3.5"
  ...
  val springMVC = "org.springframework" % "spring-webmvc" % "5.3.14"
