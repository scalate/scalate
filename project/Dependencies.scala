...
object Dependencies {
  ...
  val jettyServer = "org.eclipse.jetty" % "jetty-server" % "11.0.1"
  val jettyWebapp = jettyServer.withName("jetty-webapp")
  val jettyUtil = jettyServer.withName("jetty-util")

  val jRubyComplete = "org.jruby" % "jruby-complete" % "9.2.16.0"
  ...
  val scalaTest = Def.setting {
    Seq(
      ...
      "org.scalatestplus" %% "junit-4-13" % "3.2.6.0",
    )
  }
  val seleniumDriver = "org.seleniumhq.selenium" % "selenium-htmlunit-driver" % "2.52.0"
  val slf4jApi = "org.slf4j" % "slf4j-api" % "1.7.30"
  val springMVC = "org.springframework" % "spring-webmvc" % "5.3.4"
