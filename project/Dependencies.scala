...
object Dependencies {
  ...
  val jettyServer = "org.eclipse.jetty" % "jetty-server" % "11.0.10"
  ...
  val karafShell = "org.apache.karaf.shell" % "org.apache.karaf.shell.console" % "4.4.0"
  ...
  val springMVC = "org.springframework" % "spring-webmvc" % "5.3.21"
