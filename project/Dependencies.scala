...
object Dependencies {
  ...
  val jettyServer = "org.eclipse.jetty" % "jetty-server" % "12.1.12"
  val jettyWebapp = "org.eclipse.jetty.ee11" % "jetty-ee11-webapp" % "12.1.11"
  val jettyUtil = jettyServer.withName("jetty-util")

  val jRubyComplete = "org.jruby" % "jruby-complete" % "10.1.1.0"
  ...
  val scalaTest = Def.setting {
    Seq(
      ...
      "org.scalatestplus" %% "junit-4-13" % "3.2.20.0",
    )
  }
